 ...
 */
const DATA_URL = "data.json?v=20260628-3";
...
const EVENT_BUYING_ITEMS = [
  ...
  {
    id: "fino-the-first-drop-teetee-por",
    title: "Fino The First Drop with Teetee-Por",
    dateRange: "6月25日 到 7月20日",
    artist: "TeeTee-Por",
    summary:
      "购买 Fino Premium Touch Hair Mask 45g 满 229 泰铢并提交收据，有机会成为 30 位幸运粉丝参加 TeeTee-Por 独家见面会。",
    images: [
      "images/hddm/6.26-7.20/1.jpeg",
      "images/hddm/6.26-7.20/2.jpeg",
      "images/hddm/6.26-7.20/3.jpeg",
      "images/hddm/6.26-7.20/4.jpeg",
      "images/hddm/6.26-7.20/5.jpeg",
      "images/hddm/6.26-7.20/6.jpeg",
    ],
    detailTitle: "Fino The First Drop with Teetee-Por 活动规则",
    detailSections: [
      {
        heading: "活动重点",
        body: [
          "Fino 邀请粉丝抽选成为 30 位幸运者之一，参加 Fino The First Drop with Teetee-Por 独家见面会。",
          "活动将于 2026年8月5日 17:30 至 19:00 在 True Digital Park 举行。",
          "中奖者可获得入场资格、与 TeeTee-Por 的 2:1 拍立得合照签名、Hi-Bye 环节，以及 Fino Special Gift Set。",
        ],
      },
      {
        heading: "活动时间",
        body: [
          "购买与提交收据期间：2026年6月25日 09:00 至 2026年7月20日 18:00（泰国时间）。",
          "抽奖时间：2026年7月23日 10:00。",
          "中奖公布：2026年7月23日 16:00，通过主办方指定官方渠道公布。",
          "中奖确认时间：2026年7月24日 18:00 至 2026年7月26日 18:00。",
        ],
      },
      {
        heading: "购买条件",
        body: [
          "需购买 Fino Premium Touch Hair Mask 45g，折扣后满 229 泰铢以上。",
          "参与渠道为 Tops Daily、Tops online、Lotus’s go Fresh、Lotus online 的指定参与店铺。",
          "不包含 Shopee、Lazada、TikTok 上的 Tops Official Store 或 Lotus’s Official Store。",
          "活动收据必须只包含符合条件的 Fino Premium Touch Hair Mask 45g 商品。",
        ],
      },
      {
        heading: "抽选机会计算",
        body: [
          "2026年6月25日 09:00 至 2026年7月1日提交符合条件收据，可获得 2 次抽选机会。",
          "2026年7月2日 至 2026年7月20日 18:00 提交符合条件收据，可获得 1 次抽选机会。",
          "同一天、同一店铺购买的多张收据可以合并计算，凑满 229 泰铢可获得 1 次抽选机会。",
          "合并收据时，需把所有收据放在同一张照片中上传；重复使用的收据不可参与。",
        ],
      },
      {
        heading: "收据登记要求",
        body: [
          "参与者需在收据正面用笔写上姓名、姓氏和电话号码。",
          "需清晰拍摄所有收据，并保留原始收据作为后续确认凭证。",
          "提交登记时需填写完整资料并上传收据照片；每份登记表的购买金额需满 229 泰铢以上。",
          "可提交多份登记以增加抽选机会，但每张收据不可重复使用。",
        ],
      },
      {
        heading: "奖项内容",
        body: [
          "共 30 个中奖名额，总价值 29,910 泰铢。",
          "每位中奖者获得 Fino The First Drop with Teetee-Por 独家见面会入场资格 1 个。",
          "每位中奖者获得与 TeeTee-Por 的 2:1 拍立得合照 1 张，并含现场签名。",
          "每位中奖者可参加与 TeeTee-Por 的 Hi-Bye 环节。",
          "每位中奖者获得 Fino Special Gift Set 1 套，价值 898 泰铢。",
          "每位中奖者、每个身份证件号码，活动期间最多只能获得 1 个奖项。",
        ],
      },
      {
        heading: "中奖确认",
        body: [
          "中奖者需在指定时间内通过主办方官方渠道确认资格。",
          "确认资格时需提供身份证或护照复印件，以及购买收据照片。",
          "未在规定时间内完成确认，将视为放弃中奖资格，主办方可顺延给候补中奖者。",
        ],
      },
      {
        heading: "活动签到",
        body: [
          "签到时间：2026年8月5日 16:30 至 17:30。",
          "签到地点：True Digital Park West 3 楼 Training Room 1 前方。",
          "签到时需出示身份证或护照，以及购买收据照片。",
          "逾时未完成签到，将视为放弃参加资格。",
        ],
      },
      {
        heading: "重要条款",
        body: [
          "所有订单必须为已完成付款且未取消、未退款、未换货、未退货的有效订单。",
          "参与活动的订单如后续取消、退款、换货或退货，将立即取消参与资格。",
          "奖项不可转让、不可兑换现金，也不可更换为其它奖品。",
          "活动仅在泰国举行，所有时间均以泰国时间为准；外籍中奖者需提供可在泰国联系的电话号码。",
          "交通、住宿及其它未列入奖项的费用需由参与者自行承担。",
          "主办方保留核查资料、取消违规资格、调整或取消活动条款的权利，最终决定以主办方为准。",
        ],
      },
      {
        heading: "现场与资料使用",
        body: [
          "参与者需同意主办方在活动过程中拍摄照片、录音或录像，并可用于活动及品牌宣传。",
          "参与者需同意提供姓名、电话号码、收据号码、购买金额及收据照片等资料用于活动执行、身份确认、中奖公布与活动资料保存。",
          "主办方将保留活动相关个人资料至 2026年8月31日。",
          "参与者不得在活动中有扰乱秩序、违反法律、作弊或发布不当文字、图片、声音、视频等行为；主办方可取消资格并要求离场。",
        ],
      },
    ],
  },
